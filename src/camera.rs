// Taken from https://github.com/Twinklebear/embree-rs/blob/master/examples/support/src/camera.rs
extern crate cgmath;
use std::f32;
...
pub struct Camera {
    ...
    dir_top_left: cgmath::Vector3<f32>,
    screen_du: cgmath::Vector3<f32>,
    screen_dv: cgmath::Vector3<f32>,
    img: (u32, u32),
}
...
impl Camera {
    ...
    pub fn ray_dir(&self, px: (f32, f32)) -> cgmath::Vector3<f32> {
